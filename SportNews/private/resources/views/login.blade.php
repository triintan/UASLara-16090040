...
<html lang="en">
  ...
  <body>
	  	...
	  	<div class="container">
		      ...
		      <form class="form-login" action="#}">
		        ...
		        <div class="login-wrap">
		            ...
		            <button class="btn btn-theme btn-block" href="{{url('pengunjung')}}" type="submit"><i class="fa fa-lock"></i> SIGN IN</button>
		            <hr>		
		        </div>
    ...
    <script>
        $.backstretch("template/assets/img/login.jpg", {speed: 500});
    </script>
